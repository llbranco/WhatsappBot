...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            wait: '[ ESPERAR ] Em andamento⏳ por favor, aguarde um momento',
            error: {
                ...
                Ki: '[❗] Os bots não podem ejetar administradores de grupos!',
        ...
        const ownerNumber = ["55xxx@c.us"] // o seu numero de telefone
        ...
        case '!sgif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[❗] Envie o vídeo com a legenda *!StickerGif* max 10 seg!', id)
                )
            }
            break
	    case '!stickernobg':
